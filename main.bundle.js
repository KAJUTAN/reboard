...
var HomeComponent = (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["Observable"]
            ...
            _this.folders[0].text = _this.repoInfo.stargazers_count.toLocaleString();
            _this.folders[1].text = _this.repoInfo.forks.toLocaleString();
            _this.folders[2].text = _this.repoInfo.open_issues.toLocaleString();
            _this.folders[3].text = _this.repoInfo.size.toLocaleString();
        }, function (err) {
            console.log(err);
        });
        // this.githubService
